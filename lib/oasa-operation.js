...
class oasa_operation {
    ...
    status_response(status) {
        return this._oasd.responses[status]
            ? new oasa_response(this._spec, this._oasd.responses[status], status)
            : undefined;
    }
        ...
        for (const param of params) {
            ...
            if (param_val) {
                if (param.in() === 'query')
                    ...
                    headers[param.name()] = param_val;
                else if (param.in() === 'cookie')
                    cookies[param.name()] = param_val;
            }
        }
