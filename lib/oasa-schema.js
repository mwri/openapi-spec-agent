...
let allowed_types = ['object', 'array', 'string', 'boolean', 'number'];
...
class oasa_schema {
    ...
    interpret (data) {
        ...
        } else if (this._type === 'string' || this._type === 'number' || this._type === 'boolean' || this._type === 'any') {
            return data;
        }
    }
...
class oasa_property {
    ...
    schema () {
        return new oasa_schema(this._spec, this._oasd, undefined, this._ctx);
    }
}
