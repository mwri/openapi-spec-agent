...
class oasa_schema {
    ...
    additional_prop (name = '*') {
        return this._oasd.additionalProperties == true
            ? new oasa_property(this._spec, {}, name, this._ctx.concat('prop:'+name))
            : typeof this._oasd.additionalProperties == 'object'
            ? new oasa_property(this._spec, this._oasd.additionalProperties, name, this._ctx.concat('prop:*'))
            : undefined;
    }
