...
class oasa_spec {
    ...
    make_object (data, opts) {
        if (opts.schema)
            return opts.schema.interpret(data);
        else if (opts.schema_ref)
            return this.resolve_ref(opts.schema_ref).interpret(data);
        else if (opts.schema_name)
            return this.resolve_ref('#/components/schemas/'+opts.schema_name).interpret(data);
    }
}
